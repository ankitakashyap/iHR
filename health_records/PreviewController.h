...
#ifndef HealthRecords_PreviewController_h
#define HealthRecords_PreviewController_h
...
@property(strong,nonatomic)NSMutableArray* allergyArr;
...
@property(strong,nonatomic)NSMutableArray* immArr;
@property(strong,nonatomic)NSMutableArray* devArr;
@property(strong,nonatomic)NSString* proc;
