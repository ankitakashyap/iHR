...
//  Description: This File  displays medications history of the user in the tableview and allows the option to restrict their view to 1 months history and 6 months history
#import <Foundation/Foundation.h>
#import "MedicationsController.h"
#import "AuthViewController.h"

@interface MedicationsController()
...
@implementation MedicationsController
@synthesize segment;
...
//retrieve medications value from the table
-(void)retrieveCondDetails{
    ...
    {
        NSString  * query = @"SELECT * from MedicationsTable";
   ...
   /* [self openDB];
    NSString *sql = [NSString stringWithFormat:@"SELECT * FROM MedTable"];
