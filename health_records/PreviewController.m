...
-(void)setData{
   ...
   self.conditionsLabel.numberOfLines = [self.condArr count];
    self.allergiesLabel.numberOfLines = [self.allergyArr count];
    ...
    NSString *allrstr = @"";
    for(int i=0; i< self.allergyArr.count ; i++){
        allrstr = [allrstr stringByAppendingString:self.allergyArr[i]];
        allrstr = [allrstr  stringByAppendingString:@"\n"];
    }
    self.allergiesLabel.text = allrstr;     //set allergies value to the label
    ...
    self.procedureLabel.text = self.proc;  //set procedures value to the label
    
    NSString *devstr = @"";
    for(int i=0; i< self.devArr.count ; i++){
        devstr = [devstr stringByAppendingString:self.devArr[i]];
        devstr = [devstr  stringByAppendingString:@", "];
    }
    self.devicesLabel.text = devstr;     //set devices value to the label
